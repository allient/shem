use crate::model::relation::{Column, Constraint, ConstraintType, ReferentialAction, Relation};
...
pub async fn introspect_all_constraints<C: GenericClient>(
    ...
    for row in rows {
        ...
        map.entry(table_oid).or_default().push(Constraint {
            ...
            foreign_key_columns: row
                .get::<&str, Option<Vec<String>>>("foreign_key_columns")
                .unwrap_or_default(),
